...
INSERT INTO locations (id, name, streetAddy, city, state, zip, photo, description)
...
INSERT INTO locations (id, name, streetAddy, city, state, zip, photo, description)
VALUES (2, 'Quicken Loans Arena', '1 Center Ct.', 'Cleveland', 'OH', '44115', 'quickenloansarena', 'Feel the rush of excitement as your favorite artist takes the stage. Experience the heart-pumping adrenaline as the crowd goes wild for the home team. Quicken Loans Arena is THE place to enjoy a night out with your family and friends, where good times happen and memories are always made! Home to the NBA Cleveland Cavaliers, the AHL Cleveland Monsters, the AFL Cleveland Gladiators and host to the best entertainment in the region, The Q welcomes close to two million guests to 200+ events each year, including world-class concerts and family shows.');
